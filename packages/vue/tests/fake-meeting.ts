 ...
 * Mirrors just the public surface `usePurpleCallio` depends on, with no real
 * WebRTC/socket activity, so the composable can be unit tested in plain
 * jsdom. Modeled directly on packages/angular/tests/fake-meeting.ts and
 * packages/react-native/tests/fake-meeting.ts.
 */
