 ...
 * Mirrors just the public surface `MeetingProvider` depends on, with no real
 * WebRTC/socket activity, so the provider/hooks can be unit tested in plain
 * jsdom. Modeled directly on packages/angular/tests/fake-meeting.ts,
 * packages/react-native/tests/fake-meeting.ts, and packages/vue's.
 */
